...
<div class="navbar_miet float-left ">
    ...
    <div class="subnav_miet">
        <button class="subnavbtn_miet"><i class="fa fa fa-comments-o" aria-hidden="true"></i>ALL_FACULTY_WISE <i class="fa fa-caret-down"></i></button>
        <div class="subnav_miet-content">
            <a href="dashboard.php?info=all_faculty_wise_cse" style="margin-left:48%"><i class="fa fa-hand-o-right" aria-hidden="true"></i> CSE </a>
            ...
            <a href="dashboard.php?info=all_faculty_wise_civil"><i class="fa fa-hand-o-right" aria-hidden="true"></i> CIVIL </a>
            <a href="dashboard.php?info=all_aculty_wise_mech"><i class="fa fa-hand-o-right" aria-hidden="true"></i> MECH </a>
    ...
    <div class="row">
        <div class="col-lg-12">
            ...
            if($info!="")
            {
                ...
                else if($info=="all_faculty_wise_cse")
                {
                    $_SESSION['dept_id']=1;
                    include('all_faculty_wise.php');
                }
                else if($info=="all_faculty_wise_ece")
                {
                    $_SESSION['dept_id']=2;
                    include('all_faculty_wise.php');
                }
                else if($info=="all_faculty_wise_eee")
                {
                    $_SESSION['dept_id']=5;
                    include('all_faculty_wise.php');
                }
                else if($info=="all_faculty_wise_mech")
                {
                    $_SESSION['dept_id']=3;

                    include('all_faculty_wise.php');
                }
                else if($info=="all_faculty_wise_mba")
                {
                    $_SESSION['dept_id']=6;
                    include('all_faculty_wise.php');
                }
                else if($info=="all_faculty_wise_civil")
                {
                    $_SESSION['dept_id']=4;
                    include('all_faculty_wise.php');
                }
